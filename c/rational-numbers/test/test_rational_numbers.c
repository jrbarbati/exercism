...
int main(void)
{
	...
	RUN_TEST(test_absolute_value_of_positive_rational_with_negative_numerator_and_denominator);
	RUN_TEST(test_absolute_value_of_negative_rational_number);
	RUN_TEST(test_absolute_value_of_negative_rational_number_with_negative_denominator);
	...
	RUN_TEST(test_reduce_rational_number_with_negative_denominator_to_lowest_terms);
